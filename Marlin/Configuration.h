...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,305}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {500, 500, 3, 45}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {9000,9000,100,20000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
